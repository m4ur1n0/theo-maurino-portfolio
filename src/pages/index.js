...
export default function Home() {
  ...
  const projects = [
    ...
    {
      name : "Socratic AI",
      description : "[IN PROGRESS] Socratic educates through a Feynman-style dialogue, teaching the student to teach themselves. Implemented retrieval augmented generation (RAG) to parse textbook information. Built auth and backend systems to securely store user data.",
      date : "May, 2025",
      ...
      <div className="actual-index-page w-full md:w-[65%]  overflow-y-auto pb-10  md:py-10 px-4 flex flex-col  md:px-24" id='index-page-window' onScroll={handleScroll}>
        ...
        <div className='projects-section' id="projects">
          ...
          <div className='link-to-github py-10 w-full flex justify-center'>
              <a href='https://www.github.com/m4ur1n0' target="_blank" className='text-gray-300 text-center transition-all ease-in-out duration-200 hover:text-gray-400'>I have many more projects I haven't put on the site yet, check out my <span className='underline'>GitHub</span>!</a>
          </div>
